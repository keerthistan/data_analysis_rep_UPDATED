...
# Assuming 'accuracy' holds the accuracy rate computed previously
# Create a data frame for plotting
accuracy_data <- data.frame(
  Category = "All",  # Since you want to label this as "All"
  Accuracy = accuracy * 100  # Convert to percentage
)

# Plotting the data
ggplot(accuracy_data, aes(x = Category, y = Accuracy, fill = Category)) +
  geom_bar(stat = "identity", color = "black") +  # 'identity' to use the heights of the data
  labs(title = "KNN Classification Accuracy", 
       x = "Data", 
       y = "Accuracy (%)") +
  ylim(0, 100) +  # Set limits for the y-axis
